...
app = FastAPI(title="TrOCR Local Service", version="1.4")
...
def decode_best(pil_img: Image.Image, restrict: bool, allowed: str):
    lp = make_restricted_processor(processor.tokenizer, allowed) if restrict else None
